...
RUN apt-key adv --keyserver hkp://subkeys.pgp.net --recv-keys 0xE38CEB07
...
RUN python /opt/odoo/odoo/bootstrap.py -c /opt/odoo/odoo/buildout.docker.cfg && \
   /opt/odoo/odoo/bin/buildout -c /opt/odoo/odoo/buildout.docker.cfg
